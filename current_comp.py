...
# Paths
NASBENCH_CORPUS_NEW_PATH = '/storage/ice-shared/vip-vvk/data/AOT/psomu3/codenas/nasbench201_corpus_new.pkl'
...
print("\n" + "=" * 80)
print("NASBench-201 Robust Comparison: codellama_python_7b_pytorch_code_exclude_helper_embedding with pairwise loss and pca vs codellama_python_7b_pytorch_code_inline_embedding with pairwise loss and pca")
...
results_df = run_comparison(
    ...
    embedding2_name='codellama_python_7b_pytorch_code_inline_embedding',
    corpus2_name='nasbench201',
    corpus_path1=NASBENCH_CORPUS_NEW_PATH,
    corpus_path2=NASBENCH_CORPUS_NEW_PATH,
