...
OUTPUT_PATH = '/storage/ice-shared/vip-vvk/data/AOT/psomu3/codenas2/einspace/nasbench_einspace_comparison.csv'
OUTPUT_PATH_CSV = '/storage/ice-shared/vip-vvk/data/AOT/psomu3/codenas2/einspace'
